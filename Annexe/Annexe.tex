\documentclass[10pt,landscape]{article}
    ...
    \subsection{Format d'affichage pour fprintf }
    \begin{tabular}{@{}ll@{}}
        Valeur numérique & \%g \\
        Valeur textuelle & \%s \\
        Précision décimale & \%.4g
    \end{tabular}
    ...
    \begin{tabular}{@{}ll@{}}
    ¬ligne = fgetl(fileID)¬ & Lire une ligne \\
    ¬ligne = fgets(fileID)¬ & Lire ligne avec ¬\n¬ inclus \\
    ¬A = fscanf(fid,formatSpec)¬ & Lire données formattées\\
    ¬fprintf(fileID,formatSpec,A1)¬ & Écrire dans fichier
    \end{tabular}
    ...
    classdef NomClasse < handle
        ...
        methods
            function obj = NomClasse(inputArg1,inputArg2)
                obj.Property1 = inputArg1 + inputArg2;
            end
            function outputArg = method1(obj,inputArg)
                outputArg = obj.Property1 + inputArg;
            end
            function method2(obj,inputArg)
                obj.Property2 = obj.Property1 + inputArg;
            end
        end
    end
    \end{lstlisting}
